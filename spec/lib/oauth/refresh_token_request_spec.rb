...
module Doorkeeper::OAuth
  describe RefreshTokenRequest do
    ...
    context 'refresh tokens expire on access token use' do
      let(:server) {
        double :server, access_token_expires_in: 2.minutes, custom_access_token_expires_in: -> (_oauth_client) { nil },
               refresh_token_revoked_in: 0.seconds, refresh_token_revoked_on_use: true, refresh_token_enabled?: true }
